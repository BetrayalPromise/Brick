...
extension Layoutable {
    ...
    public func setContentHuggingPriorty(for axis: LayoutAxis, priorty: LayoutPriority) {
        switch axis {
        case .horizontal: layoutManager.contentSizeConstraints.xAxis.huggingPriorty = priorty
        case .vertical: layoutManager.contentSizeConstraints.yAxis.huggingPriorty = priorty
        }
    }
    
    public func contentHuggingPriorty(for axis: LayoutAxis) -> LayoutPriority {
        switch axis {
        case .horizontal: return layoutManager.contentSizeConstraints.xAxis.huggingPriorty
        case .vertical: return layoutManager.contentSizeConstraints.yAxis.huggingPriorty
        }
    }
    
    public func setContentCompressionPriorty(for axis: LayoutAxis, priorty: LayoutPriority) {
        switch axis {
        case .horizontal: layoutManager.contentSizeConstraints.xAxis.compressionPriorty = priorty
        case .vertical: layoutManager.contentSizeConstraints.yAxis.compressionPriorty = priorty
        }
    }
    
    public func contentCompressionPriorty(for axis: LayoutAxis) -> LayoutPriority {
        switch axis {
        case .horizontal: return layoutManager.contentSizeConstraints.xAxis.compressionPriorty
        case .vertical: return layoutManager.contentSizeConstraints.yAxis.compressionPriorty
        }
    }
}
